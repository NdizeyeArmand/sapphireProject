...
function checkEnvVariable(name, value) {
  return value ? process.env[name] === value : !utilities.isNullish(process.env[name]);
}
...
var CanLoadTypeScriptFiles = (
  ...
  !utilities.isNullish(process.env.TS_NODE_DEV) || //
  // @babel/node
...
exports.CanLoadTypeScriptFiles = CanLoadTypeScriptFiles;
